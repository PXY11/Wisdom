function qctrigger = calculateqctrigger_threedividends_part2_fixedr(S0, Shistory, ctrigger,T,r,sigma,no_call_time,n,m,ncX,D1_time,D1,D2_time)
%% parameter input
% clc;
% clear;
% S0=18.21;
...
for i=1:2*N
    ...
    ctrigger_sequence(D1_time/d_t+m:end)=ctrigger-ncX*D1;
    ...
    if T+(m-1)*d_t<=no_call_time(1)-d_t
        ...
        if left_j>m
            ...
            if left_triggertime>=D1_time  %分红后
