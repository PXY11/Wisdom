function difference = calculateqctrigger_threedividends_part2_fixedr_test2(S0, Shistory, ctrigger, qctrigger,T,r,sigma,no_call_time,n,m,ncX,D1_time,D1,D2_time)
%% parameter input
% clc;
% clear;
% S0=18.21;
