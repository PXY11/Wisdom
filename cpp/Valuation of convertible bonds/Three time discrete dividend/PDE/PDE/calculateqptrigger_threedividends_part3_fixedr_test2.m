function difference = calculateqptrigger_threedividends_part3_fixedr_test2(S0, Shistory, ptrigger, qptrigger,T,r,sigma,no_put_time,n,m,npX,D1_time,D1,D2_time,D2,D3_time)
%% parameter input
% clc;
% clear;
% S0=18.21;
