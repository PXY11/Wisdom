function difference = calculateqptrigger_threedividends_part1_fixedr_test2(S0, Shistory, ptrigger, qptrigger,T,r,sigma,no_put_time,n,m,D1_time)
%% parameter input
% clc;
% clear;
% S0=18.21;
...
for i=1:2*N
    ...
    ptrigger_sequence(1:end)=ptrigger;
