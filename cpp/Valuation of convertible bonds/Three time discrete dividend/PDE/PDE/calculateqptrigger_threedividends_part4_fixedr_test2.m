function difference = calculateqptrigger_threedividends_part4_fixedr_test2(S0, Shistory, ptrigger, qptrigger,T,r,sigma,no_put_time,n,m,npX,D1_time,D1,D2_time,D2,D3_time,D3)
%% parameter input
% clc;
% clear;
% S0=18.21;
...
for i=1:2*N
    ...
    ptrigger_sequence(D2_time/d_t:D3_time/d_t-1+m)=ptrigger-npX*(D1+D2);
    ptrigger_sequence(D3_time/d_t:M+m)=ptrigger-npX*(D1+D2+D3);
