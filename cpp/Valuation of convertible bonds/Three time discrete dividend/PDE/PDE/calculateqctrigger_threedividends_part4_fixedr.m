function qctrigger = calculateqctrigger_threedividends_part4_fixedr(S0, Shistory, ctrigger,T,r,sigma,no_call_time,n,m,ncX,D1_time,D1,D2_time,D2,D3_time,D3)
%% parameter input
% clc;
% clear;
% S0=18.21;
...
for i=1:2*N
    ...
    if T+(m-1)*d_t<=no_call_time(1)-d_t
        ...
        if left_j>m
            ...
            if left_triggertime>=D3_time  %分红后
