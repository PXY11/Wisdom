...
double PDESolver::solve()
{
    ...
    for (int n=1; n<=this->pde_param_ptr->Nt; n++)
    {
        ...
        rate1 = interpCB(this->pde_param_ptr->rate_T,this->pde_param_ptr->risk_free_rate,n*this->pde_param_ptr->dt);//dt = 0.002
        rate2 = interpCB(this->pde_param_ptr->rate_T,this->pde_param_ptr->risk_free_rate,(n-1)*this->pde_param_ptr->dt);
...
double PDESolver::calBpstar()
{
    ...
    for(int i=1;i<M;i++)
    {
        rate1 = interpCB(this->pde_param_ptr->rate_T,this->pde_param_ptr->risk_free_rate,i*d_t);
        rate2 = interpCB(this->pde_param_ptr->rate_T,this->pde_param_ptr->risk_free_rate,(i-1)*d_t);
